...
class HikDevice:
    ...
    def device_info(self) -> DeviceInfo:
        ...
        return DeviceInfo(
            identifiers={(const.DOMAIN, str(self._ref_id) + "-" + str(self.zone.id))},
...
class HikTemperature(CoordinatorEntity, HikDevice, SensorEntity):
    ...
    def __init__(self, coordinator: HikAxProDataUpdateCoordinator, zone: Zone, entry_id: str) -> None:
        ...
        self._attr_native_unit_of_measurement = const.UnitOfTemperature.CELSIUS
        self._attr_has_entity_name = True
...
class HikHumidity(CoordinatorEntity, HikDevice, SensorEntity):
    ...
    def __init__(self, coordinator: HikAxProDataUpdateCoordinator, zone: Zone, entry_id: str) -> None:
        ...
        self._attr_native_unit_of_measurement = const.PERCENTAGE
        self._attr_has_entity_name = True
...
class HikSignalInfo(CoordinatorEntity, HikDevice, SensorEntity):
    ...
    def __init__(self, coordinator: HikAxProDataUpdateCoordinator, zone: Zone, entry_id: str) -> None:
        ...
        self._attr_native_unit_of_measurement = const.SIGNAL_STRENGTH_DECIBELS_MILLIWATT
        self._attr_entity_category = EntityCategory.DIAGNOSTIC
        self._attr_has_entity_name = True
